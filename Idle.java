...
public class Idle {
    ...
    static JPanel field, leftfield,rightfield,midfield,midleft,midright,midmid,sysfield;
    static int rowno,colno;
    static JButton main, firstB,secondB,thirdB,fourthB, firstU,secondU,thirdU,fourthU,sellsys;
    static GridLayout sublays,sysnew;
    static JTextArea fB,sB,tB,yB,fU,sU,tU,yU,maindesc;
    static int clicklvl, personlvl,complvl,systemlvl;
    static Dimension d;
    static float money,personmps,compmps,systemmps,clickcost,personcost,compcost, syscost,cmultcost,pmultcost,compmultcost,smultcost,clickmult,personmult,compmult,systemmult,inc,uInc,clickbase,personbase,compbase,sysbase,cmultbase,pmultbase,compmultbase,smultbase,fps,sysboost;
